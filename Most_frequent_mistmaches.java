...
class Most_frequent_mistmaches
{
    ...
    public static void main(String [] args)
    {
        ...
        indice_mayor     =new int[4000];                      //define (longitud/kmer) elementos en el arreglo indice_mayor
        for (ii=0; ii < kmer; ii++)                           //inicializa el arreglo de los índices de número de letras de las cadenas k-mer del 0 al -kmer
            indice[ii]=kmer - 1 + ii;
        for (ii=0; ii < 4000; ii++) //inicializa el arreglo de los indicecs mayores de las cadenas k-mer en cero
            indice_mayor[ii]=0;
